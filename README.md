...
This mod provides detailed **TPS (Ticks Per Second) monitoring** for each world on a Hytale server.

## Features

- Displays the **configured target TPS** for each world.  
- Shows the **real-time TPS** calculated from actual tick progression.  
